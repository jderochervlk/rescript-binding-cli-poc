...
import * as t from "node:child_process";
...
import { AsyncLocalStorage as c, AsyncResource as l } from "node:async_hooks";
import { stripVTControlCharacters as u, styleText as d } from "node:util";
import * as f from "node:readline";
import * as p from "node:os";
import * as m from "node:crypto";
import * as h from "node:readline/promises";
var g = Object.create,
  ...
  w = (e, t, n) => (
    (n = e == null ? {} : g(b(e))),
    C(t || !e || !e.__esModule ? _(n, `default`, { value: e, enumerable: !0 }) : n, e)
  ),
  T = e(import.meta.url),
  E = S((e) => {
...
- unrecognised flag format`);
  ...
  ie = S((e) => {
    let t = T(`node:events`).EventEmitter,
      n = T(`node:child_process`),
      r = T(`node:path`),
      i = T(`node:fs`),
      a = T(`node:process`),
      { Argument: o, humanReadableArgName: s } = ee(),
      { CommanderError: c } = E(),
      { Help: l, stripColor: u } = te(),
      { Option: d, DualOptions: f } = ne(),
      { suggestSimilar: p } = re();
      ...
      constructor(e) {
        (super(),
          ...
          (this._outputConfiguration = {
            ...
            getOutHasColors: () => g() ?? (a.stdout.isTTY && a.stdout.hasColors?.()),
            getErrHasColors: () => g() ?? (a.stderr.isTTY && a.stderr.hasColors?.()),
            stripColor: (e) => u(e),
          }),
          (this._hidden = !1),
...
const {
  ...
  S((e) => {
    let { Argument: t } = ee(),
      { Command: n } = ie(),
      { CommanderError: r, InvalidArgumentError: i } = E(),
      { Help: a } = te(),
      { Option: o } = ne();
    ((e.program = new n()),
...
function _e(e) {
  ...
  throw { RE_EXN_ID: `Not_found`, Error: Error() };
}
function ve(e, t) {
  if (e !== void 0) return t(D(e));
}
function O(e, t) {
  return e === void 0 ? t : D(e);
}
function ye(e, t) {
  return e === void 0 ? t : e;
}
...
function be(e) {
  let t = [];
  return (
    [e.peerDependencies, e.dependencies, e.devDependencies].forEach((e) => {
      if (e !== void 0) {
        t.push(D(e));
        return;
      }
...
function A(e, t) {
  let n = { contents: void 0 };
  return (
    be(e).forEach((e) => {
      if (n.contents !== void 0) return;
      let r = e[t];
      if (r !== void 0 && r.trim() !== ``) {
        n.contents = r;
        return;
...
function j(e) {
  if (e.RE_EXN_ID === `JsExn`) return ge(e._1);
}
let we = (
    (e) => (t) =>
      t && typeof t[e] == `string` ? t[e] : void 0
  )(`message`),
  Te = `https://rescript-binding-registry.josh-401.workers.dev/api`,
  M = Te + `/publish`,
  N = M + `/v1/me`;
function Ee(e) {
  return e === void 0
...
function Oe(e) {
  return {
    author: e.author,
    packageText: e.packageRange + ` - ` + Ee(e.isPackageCompatible),
    rescriptText: e.rescriptRange + ` - ` + De(e.isRescriptCompatible),
  };
}
function ke(e) {
  return e >= 48 ? e <= 57 : !1;
...
function Ae(e) {
  return e >= 65 && e <= 90 ? !0 : e >= 97 ? e <= 122 : !1;
}
function je(e) {
  return Ae(e) ? !0 : ke(e);
}
function Me(e) {
  return e.length === 0 ? e : e.slice(0, 1).toUpperCase() + e.slice(1, e.length);
}
function Ne(e) {
...
function Pe(e) {
  ...
  for (let r = 0, i = e.length; r < i; ++r)
    je(e.charCodeAt(r)) ? (n += e.slice(r, (r + 1) | 0)) : n !== `` && (t.push(n), (n = ``));
  return (n !== `` && t.push(n), t);
}
function Fe(e) {
  let t = Pe(e).map(Me).join(``);
  return t === `` ? `Binding` : Ne(t) ? t : `Binding` + t;
}
function Ie(e) {
  return e == null ? !1 : typeof e.RE_EXN_ID == `string`;
}
function P(e) {
  return Ie(e) ? e : { RE_EXN_ID: `JsExn`, _1: e };
}
let Le = {};
function Re(e) {
  let t = Le[e];
...
let F = Re(`AddModuleFilename.InvalidFilename`),
  I = `Install filename must be a valid ReScript module filename, like InquirerPrompts.res.`;
function ze(e) {
  return e >= 48 ? e <= 57 : !1;
}
function Be(e) {
...
function He(e) {
  if (e.endsWith(`.resi`)) return [e.slice(0, (e.length - 5) | 0), `.resi`];
  if (e.endsWith(`.res`)) return [e.slice(0, (e.length - 4) | 0), `.res`];
  throw { RE_EXN_ID: F, _1: I, Error: Error() };
}
function Ue(e) {
  if (e.length === 0 || !Be(e.charCodeAt(0))) throw { RE_EXN_ID: F, _1: I, Error: Error() };
  for (let t = 0, n = e.length; t < n; ++t)
    if (!Ve(e.charCodeAt(t))) throw { RE_EXN_ID: F, _1: I, Error: Error() };
}
function We(e) {
  let t = He(e),
    n = t[0];
  return (Ue(n), n.slice(0, 1).toUpperCase() + n.slice(1, n.length) + t[1]);
}
function Ge(e) {
  let t = e.replaceAll(`\\`, `/`).trim();
  if (t === `` || t === `.`) throw { RE_EXN_ID: F, _1: I, Error: Error() };
  let n = t.split(`/`).filter((e) => e !== ``),
    r = n.length;
  if (r === 0) throw { RE_EXN_ID: F, _1: I, Error: Error() };
  let i = n[(r - 1) | 0],
    a;
  if (i !== void 0) a = We(i);
  else throw { RE_EXN_ID: F, _1: I, Error: Error() };
  return r === 1 ? a : n.slice(0, (r - 1) | 0).join(`/`) + `/` + a;
}
function Ke(e, t) {
  return e === `` ? t : e.endsWith(`/`) ? e + t : e + `/` + t;
}
function qe(e) {
  return Ke(`src/bindings`, Fe(e));
}
function Je(e, t) {
  return Ke(`src/bindings`, Fe(e)) + t;
}
let Ye = function (e, t) {
  for (var n in e) t(n);
};
function L(e, t) {
  ...
  if (n === `function` || r === `function`)
    throw { RE_EXN_ID: `Invalid_argument`, _1: `equal: functional value`, Error: Error() };
  if (r === `number` || r === `bigint` || r === `undefined` || t === null || e.TAG !== t.TAG)
    return !1;
  let i = e.length | 0;
  if (i === (t.length | 0))
    if (Array.isArray(e)) {
    ...
    } else if (e instanceof Date && t instanceof Date) return !(e > t || e < t);
    else {
      let n = { contents: !0 };
      return (
        Ye(e, (e) => {
        ...
        n.contents &&
          Ye(t, (r) => {
            if (!Object.prototype.hasOwnProperty.call(e, r) || !L(t[r], e[r])) {
              n.contents = !1;
              return;
            }
          }),
...
const R = (e, t = []) =>
    e.name === `up` ||
    (t.includes(`vim`) && e.name === `k`) ||
    (t.includes(`emacs`) && e.ctrl && e.name === `p`),
  z = (e, t = []) =>
    e.name === `down` ||
    (t.includes(`vim`) && e.name === `j`) ||
    (t.includes(`emacs`) && e.ctrl && e.name === `n`),
  Ze = (e) => e.name === `backspace`,
  Qe = (e) => e.name === `tab`,
  $e = (e) => `1234567890`.includes(e.name),
  et = (e) => e.name === `enter` || e.name === `return`;
var tt = class extends Error {
    name = `AbortPromptError`;
    message = `Prompt was aborted`;
    constructor(e) {
      (super(), (this.cause = e?.cause));
    }
  },
...
const ot = new c();
function st(e) {
  return { rl: e, hooks: [], hooksCleanup: [], hooksEffect: [], index: 0, handleChange() {} };
}
function ct(e, t) {
  let n = st(e);
  return ot.run(n, () => {
...
function B() {
  let e = ot.getStore();
  if (!e) throw new it(`[Inquirer] Hook functions can only be called from within a prompt`);
  return e;
}
function lt() {
  return B().rl;
  ...
  queue(e) {
    ...
    t.hooksEffect.push(() => {
      ...
      if (r != null && typeof r != `function`)
        throw new at(`useEffect return value must be a cleanup function or nothing.`);
      t.hooksCleanup[n] = r;
    });
  },
  run() {
...
function H(e) {
  return dt((t) => {
    let n = l.bind(function (e) {
      t.get() !== e && (t.set(e), ft());
    });
    if (t.initialized) return [t.get(), n];
    let r = pt(e) ? e() : e;
    return (t.set(r), [r, n]);
  });
}
function U(e, t) {
  dt((n) => {
    let r = n.get();
    ((!Array.isArray(r) || t.some((e, t) => !Object.is(e, r[t]))) && V.queue(e), n.set(t));
  });
}
function mt() {
  return o.platform.startsWith(`win`)
    ? !!o.env.CI ||
        !!o.env.WT_SESSION ||
        !!o.env.TERMINUS_SUBLIME ||
        o.env.ConEmuTask === `{cmd::Cmder}` ||
        o.env.TERM_PROGRAM === `Terminus-Sublime` ||
        o.env.TERM_PROGRAM === `vscode` ||
        o.env.TERM === `xterm-256color` ||
        o.env.TERM === `alacritty` ||
        o.env.TERMINAL_EMULATOR === `JetBrains-JediTerm`
    : o.env.TERM !== `linux`;
}
const ht = {
    circleQuestionMark: `(?)`,
...
Object.entries(gt);
const bt = {
  prefix: { idle: d(`blue`, `?`), done: d(`green`, W.tick) },
  spinner: {
    interval: 80,
    frames: [`⠋`, `⠙`, `⠹`, `⠸`, `⠼`, `⠴`, `⠦`, `⠧`, `⠇`, `⠏`].map((e) => d(`yellow`, e)),
  },
  style: {
    answer: (e) => d(`cyan`, e),
    message: (e) => d(`bold`, e),
    error: (e) => d(`red`, `> ${e}`),
    defaultAnswer: (e) => d(`dim`, `(${e})`),
    help: (e) => d(`dim`, e),
    highlight: (e) => d(`cyan`, e),
    key: (e) => d(`cyan`, d(`bold`, `<${e}>`)),
  },
};
function xt(e) {
...
function St(...e) {
  ...
  for (let n of e)
    for (let [e, r] of Object.entries(n)) {
      let n = t[e];
      t[e] = xt(n) && xt(r) ? St(n, r) : r;
    }
  return t;
}
function Ct(...e) {
  return St(bt, ...e.filter((e) => e != null));
}
function wt({ status: e = `idle`, theme: t }) {
  let [n, r] = H(!1),
    [i, a] = H(0),
    { prefix: o, spinner: s } = Ct(t);
  return (
    U(() => {
      if (e === `loading`) {
        let e,
          ...
          n = setTimeout(() => {
            (r(!0),
              (e = setInterval(() => {
                ((t += 1), a(t % s.frames.length));
              }, s.interval)));
          }, 300);
        return () => {
          (clearTimeout(n), clearInterval(e));
        };
      } else r(!1);
    }, [e]),
    n ? s.frames[i] : typeof o == `string` ? o : (o[e === `loading` ? `idle` : e] ?? o.idle)
  );
}
function G(e, t) {
  return dt((n) => {
    let r = n.get();
    if (!r || r.dependencies.length !== t.length || r.dependencies.some((e, n) => e !== t[n])) {
      let r = e();
      return (n.set({ value: r, dependencies: t }), r);
    }
    return r.value;
  });
}
function K(e) {
  return H({ current: e })[0];
}
function Tt(e) {
  let t = K(e);
  ((t.current = e),
    U((e) => {
      ...
      return (
        e.input.on(`keypress`, r),
        () => {
          ((n = !0), e.input.removeListener(`keypress`, r));
        }
      );
    }, []));
}
var Et = S((e, t) => {
  t.exports = r;
  function n(e) {
    let t = { defaultWidth: 0, output: process.stdout, tty: T(`tty`) };
    return e
  ...
  function r(e) {
    ...
    if (process.env.CLI_WIDTH) {
      let e = parseInt(process.env.CLI_WIDTH, 10);
...
const Dt = (() => {
  ...
  Ot = (e) => e === 12288 || (e >= 65281 && e <= 65376) || (e >= 65504 && e <= 65510),
  kt = (e) =>
    e === 8987 ||
    e === 9001 ||
    (e >= 12272 && e <= 12287) ||
  ...
  jt = /[\x00-\x08\x0A-\x1F\x7F-\x9F]{1,1000}/y,
  Mt =
  ...
  Ft = /(?:[\x20-\x7E\xA0-\xFF](?!\uFE0F)){1,1000}/y,
  It = /\p{M}+/gu,
  Lt = { limit: 1 / 0, ellipsis: `` },
  Rt = (e, t = {}, n = {}) => {
    let r = t.limit ?? 1 / 0,
      i = t.ellipsis ?? ``,
      a = t?.ellipsisWidth ?? (i ? Rt(i, Lt, n).width : 0),
      o = n.controlWidth ?? 0,
      s = n.tabWidth ?? 8,
      c = n.emojiWidth ?? 2,
      l = n.regularWidth ?? 1,
    ...
    outer: for (;;) {
      if (b > y || (p >= m && p > f)) {
        ...
        h = 0;
        for (let e of t.replaceAll(It, ``)) {
          let t = e.codePointAt(0) || 0;
          if (
            ((S = Ot(t) ? 2 : kt(t) ? u : l),
            x + S > v && (_ = Math.min(_, Math.max(y, f) + h)),
            x + S > r)
          ) {
            g = !0;
            break outer;
      ...
      for (let t = 0, n = d.length; t < n; t++) {
        ...
        if (((n.lastIndex = p), n.test(e))) {
          if (
            ((h = n === Mt ? Dt(e.slice(p, n.lastIndex)) : n === Pt ? 1 : n.lastIndex - p),
            (S = h * i),
            x + S > v && (_ = Math.min(_, p + Math.floor((v - x) / i))),
            x + S > r)
          ) {
            g = !0;
            break outer;
    ...
    return { width: g ? v : x, index: g ? _ : m, truncated: g, ellipsed: g && r >= a };
  },
  zt = { limit: 1 / 0, ellipsis: ``, ellipsisWidth: 0 },
  q = (e, t = {}) => Rt(e, zt, t).width,
  Bt = `]8;;`,
  Vt = RegExp(`(?:\\[(?<code>\\d+)m|\\${Bt}(?<uri>.*))`, `y`),
  Ht = (e) => {
  ...
  Gt = (e, t, n) => {
    ...
    for (; !c.done; ) {
      let o = c.value,
        d = q(o);
      (s + d <= n ? (e[e.length - 1] += o) : (e.push(o), (s = 0)),
        (o === `\x1B` || o === ``) && ((i = !0), (a = t.startsWith(Bt, u + 1))),
        i
          ? a
            ? o === `\x07` && ((i = !1), (a = !1))
            : o === `m` && (i = !1)
          : ((s += d), s === n && !l.done && (e.push(``), (s = 0))),
        (c = l),
        (l = r.next()),
        (u += o.length));
    }
    ((o = e.at(-1)),
      !s && o !== void 0 && o.length && e.length > 1 && (e[e.length - 2] += e.pop()));
  },
  Kt = (e) => {
    let t = e.split(` `),
      n = t.length;
  ...
  qt = (e, t, n = {}) => {
    ...
    for (let e = 0; e < o.length; e++) {
      ...
      if (n.trim !== !1) {
        let e = s.at(-1) ?? ``,
          t = e.trimStart();
        e.length !== t.length && ((s[s.length - 1] = t), (c = q(t)));
      }
      e !== 0 &&
        (c >= t && (n.wordWrap === !1 || n.trim === !1) && (s.push(``), (c = 0)),
        (c || n.trim === !1) && ((s[s.length - 1] += ` `), c++));
      let i = q(r);
      if (n.hard && i > t) {
        let e = t - c,
          n = 1 + Math.floor((i - e - 1) / t);
        (Math.floor((i - 1) / t) < n && s.push(``), Gt(s, r, t), (c = q(s.at(-1) ?? ``)));
        continue;
      }
      if (c + i > t && c && i) {
        if (n.wordWrap === !1 && c < t) {
...
function Qt() {
  return (0, Xt.default)({ defaultWidth: 80, output: lt().output });
}
function $t({ active: e, renderedItems: t, pageSize: n, loop: r }) {
  let i = K({ lastPointer: e, lastActive: void 0 }),
    { lastPointer: a, lastActive: o } = i.current,
    s = Math.floor(n / 2),
    c = t.reduce((e, t) => e + t.length, 0),
    l = t.slice(0, e).reduce((e, t) => e + t.length, 0),
    u = l;
  if (c > n)
    if (r)
      ((u = a),
        o != null &&
          ...
          (u = Math.min(
            s,
            Math.abs(e - o) === 1 ? Math.min(a + (t[o]?.length ?? 0), Math.max(l, a)) : a + e - o,
          )));
    else {
      let r = t.slice(e).reduce((e, t) => e + t.length, 0);
      u = r < n - s ? n - r : Math.min(l, s);
    }
  return ((i.current.lastPointer = u), (i.current.lastActive = e), u);
}
function en({ items: e, active: t, renderItem: n, pageSize: r, loop: i = !0 }) {
  let a = Qt(),
    o = (t) => ((t % e.length) + e.length) % e.length,
    s = e.map((e, r) =>
      e == null
        ? []
        : Zt(n({ item: e, index: r, isActive: r === t }), a).split(`
`),
    ),
    c = s.reduce((e, t) => e + t.length, 0),
    l = (e) => s[e] ?? [],
    u = $t({ active: t, renderedItems: s, pageSize: r, loop: i }),
    d = l(t).slice(0, r),
    f = u + d.length <= r ? u : r - d.length,
    p = Array.from({ length: r });
  p.splice(f, d.length, ...d);
  let m = new Set([t]),
    h = f + d.length,
    g = o(t + 1);
  for (; h < r && !m.has(g) && (i && c > r ? g !== t : g > t); ) {
    let e = l(g).slice(0, r - h);
    (p.splice(h, e.length, ...e), m.add(g), (h += e.length), (g = o(g + 1)));
  }
  for (h = f - 1, g = o(t - 1); h >= 0 && !m.has(g) && (i && c > r ? g !== t : g < t); ) {
    let e = l(g),
      t = e.slice(Math.max(0, e.length - h - 1));
    (p.splice(h - t.length + 1, t.length, ...t), m.add(g), (h -= t.length), (g = o(g - 1)));
  }
  return p.filter((e) => typeof e == `string`).join(`
`);
}
var tn = S((e, t) => {
  let n = T(`stream`);
  t.exports = class extends n {
    ...
    #t(e, t) {
      return this._dest ? this._dest[e] : this._src ? this._src[e] : t;
    }
    #n(e, ...t) {
      (typeof this._dest?.[e] == `function` && this._dest[e](...t),
        typeof this._src?.[e] == `function` && this._src[e](...t));
    }
    get isTTY() {
      return this.#e === null ? this.#t(`isTTY`, !1) : this.#e;
    }
    set isTTY(e) {
      this.#e = e;
    }
    ...
    pipe(e, t) {
      return ((this._dest = e), super.pipe(e, t));
    }
    pause() {
    ...
    write(e) {
      ...
      (this.muted && (e = e && this.replace ? e.toString().replace(/./g, this.replace) : null),
        e && this.emit(`data`, e),
        this.emit(`end`));
    }
    destroy(...e) {
...
const Y = (e) =>
  ...
  nn = Symbol.for(`signal-exit emitter`),
  rn = globalThis,
  an = Object.defineProperty.bind(Object);
var on = class {
    ...
    id = Math.random();
    constructor() {
      if (rn[nn]) return rn[nn];
      an(rn, nn, { value: this, writable: !1, enumerable: !1, configurable: !1 });
    }
    on(e, t) {
    ...
    removeListener(e, t) {
      let n = this.listeners[e],
        r = n.indexOf(t);
      r !== -1 && (r === 0 && n.length === 1 ? (n.length = 0) : n.splice(r, 1));
    }
    emit(e, t, n) {
      if (this.emitted[e]) return !1;
      this.emitted[e] = !0;
      let r = !1;
      for (let i of this.listeners[e]) r = i(t, n) === !0 || r;
      return (e === `exit` && (r = this.emit(`afterExit`, t, n) || r), r);
    }
  },
  sn = class {};
const cn = (e) => ({
...
var ln = class extends sn {
  ...
  un = class extends sn {
    #e = dn.platform === `win32` ? `SIGINT` : `SIGHUP`;
    #t = new on();
    #n;
    #r;
    #i;
    ...
    #o = !1;
    constructor(e) {
      (super(), (this.#n = e), (this.#a = {}));
      for (let t of J)
        this.#a[t] = () => {
          let n = this.#n.listeners(t),
            { count: r } = this.#t,
            i = e;
          if (
            (typeof i.__signal_exit_emitter__ == `object` &&
              typeof i.__signal_exit_emitter__.count == `number` &&
              (r += i.__signal_exit_emitter__.count),
            n.length === r)
          ) {
            this.unload();
            let n = this.#t.emit(`exit`, null, t),
              r = t === `SIGHUP` ? this.#e : t;
            n || e.kill(e.pid, r);
          }
        };
      ((this.#i = e.reallyExit), (this.#r = e.emit));
    }
    onExit(e, t) {
      if (!Y(this.#n)) return () => {};
      this.#o === !1 && this.load();
    ...
    load() {
      if (!this.#o) {
        ((this.#o = !0), (this.#t.count += 1));
        for (let e of J)
          try {
            let t = this.#a[e];
            t && this.#n.on(e, t);
          } catch {}
        ((this.#n.emit = (e, ...t) => this.#c(e, ...t)), (this.#n.reallyExit = (e) => this.#s(e)));
      }
    }
    unload() {
      this.#o &&
        ...
        J.forEach((e) => {
          ...
          try {
            this.#n.removeListener(e, t);
          } catch {}
        }),
        (this.#n.emit = this.#r),
        (this.#n.reallyExit = this.#i),
        --this.#t.count);
    }
    #s(e) {
      return Y(this.#n)
        ? ((this.#n.exitCode = e || 0),
          this.#t.emit(`exit`, this.#n.exitCode, null),
          this.#i.call(this.#n, this.#n.exitCode))
        : 0;
    }
    #c(e, ...t) {
      let n = this.#r;
      if (e === `exit` && Y(this.#n)) {
        typeof t[0] == `number` && (this.#n.exitCode = t[0]);
        let r = n.call(this.#n, e, ...t);
        return (this.#t.emit(`exit`, this.#n.exitCode, null), r);
      } else return n.call(this.#n, e, ...t);
    }
  };
const dn = globalThis.process,
  { onExit: fn, load: pn, unload: mn } = cn(Y(dn) ? new un(dn) : new ln()),
  hn = (e = 1) => (e > 0 ? `[${e}A` : ``),
  gn = (e = 1) => (e > 0 ? `[${e}B` : ``),
  _n = (e, t) =>
    typeof t == `number` && !Number.isNaN(t) ? `[${t + 1};${e + 1}H` : `[${e + 1}G`,
  vn = `\x1B[2K`,
  yn = (e) => (e > 0 ? (vn + hn(1)).repeat(e - 1) + vn + `\x1B[G` : ``),
  bn = (e) =>
    e.split(`
`).length,
  xn = (e) =>
...
var Sn = class {
    ...
    rl;
    constructor(e) {
      ((this.rl = e), (this.cursorPos = e.getCursorPos()));
    }
    write(e) {
    ...
    render(e, t = ``) {
      let n = u(xn(e)),
        r = n;
      (this.rl.line.length > 0 && (r = r.slice(0, -this.rl.line.length)),
        this.rl.setPrompt(r),
...
` + t
            : ``),
        o = Math.floor(n.length / i) - this.cursorPos.rows + (t ? bn(t) : 0);
      (o > 0 && (a += hn(o)),
        (a += _n(this.cursorPos.cols)),
        this.write(gn(this.extraLinesUnderPrompt) + yn(this.height) + a),
        (this.extraLinesUnderPrompt = o),
        (this.height = bn(a)));
    }
    checkCursorPos() {
      let e = this.rl.getCursorPos();
      e.cols !== this.cursorPos.cols && (this.write(_n(e.cols)), (this.cursorPos = e));
    }
    done({ clearContent: e }) {
      this.rl.setPrompt(``);
      let t = gn(this.extraLinesUnderPrompt);
      ((t += e
        ? yn(this.height)
        : `
`),
  ...
  wn = w(tn(), 1);
const Tn = globalThis.setImmediate;
function En() {
  let e = Error.prepareStackTrace,
    t = [];
  try {
    ((Error.prepareStackTrace = (e, n) => {
      let r = n.slice(1);
      return ((t = r), r);
    }),
      Error().stack);
...
function Dn(e) {
  let t = En();
  return (n, i = {}) => {
    let { input: a = process.stdin, signal: o } = i,
      s = new Set(),
      c = new wn.default();
    c.pipe(i.output ?? process.stdout);
    let u = f.createInterface({ terminal: !0, input: a, output: c });
    c.mute();
    let d = new Sn(u),
      { promise: p, resolve: m, reject: h } = Cn.withResolver(),
      g = () => h(new nt());
    if (o) {
      let e = () => h(new tt({ cause: o.reason }));
      if (o.aborted) return (e(), Object.assign(p, { cancel: g }));
      (o.addEventListener(`abort`, e), s.add(() => o.removeEventListener(`abort`, e)));
    }
    s.add(
      fn((e, t) => {
        h(new rt(`User force closed the prompt with ${e} ${t}`));
      }),
    );
    let _ = () => h(new rt(`User force closed the prompt with SIGINT`));
    return (
      u.on(`SIGINT`, _),
      s.add(() => u.removeListener(`SIGINT`, _)),
      ct(u, (o) => {
        let f = l.bind(() => V.clearAll());
        (u.on(`close`, f), s.add(() => u.removeListener(`close`, f)));
        let _ = () => {
          let i = () => d.checkCursorPos();
          (u.input.on(`keypress`, i), s.add(() => u.input.removeListener(`keypress`, i)));
          let a = null;
          o(() => {
            let i = !1;
            try {
              ...
              if (o === void 0) {
                let e = t[1]?.getFileName();
                throw (
                  e && !e.startsWith(`file://`) && (e = r.resolve(e)),
                  Error(`Prompt functions must return a string.\n    at ${e}`)
                );
              }
              let [s, c] = typeof o == `string` ? [o] : o;
              (d.render(s, c), V.run());
            } catch (e) {
              h(e);
            }
        ...
        return (
          ...
          Object.assign(
            p
              ...
              .finally(() => {
                (s.forEach((e) => e()), d.done({ clearContent: !!i.clearPromptOnDone }), c.end());
              })
              .then(() => p),
            { cancel: g },
          )
...
var X = class {
  separator = d(`dim`, Array.from({ length: 15 }).join(W.line));
  type = `separator`;
  constructor(e) {
    e && (this.separator = e);
  }
...
const On = {
  icon: { cursor: W.pointer },
  style: {
    disabled: (e) => d(`dim`, `- ${e}`),
    searchTerm: (e) => d(`cyan`, e),
    description: (e) => d(`cyan`, e),
    keysHelpTip: (e) => e.map(([e, t]) => `${d(`bold`, e)} ${d(`dim`, t)}`).join(d(`dim`, ` • `)),
  },
};
function Z(e) {
  return !X.isSeparator(e) && !e.disabled;
}
function kn(e) {
  return e.map((e) => {
    if (X.isSeparator(e)) return e;
    if (typeof e != `object` || !e || !(`value` in e)) {
      let t = String(e);
      return { value: e, name: t, short: t, disabled: !1 };
    }
    let t = e.name ?? String(e.value),
      n = { value: e.value, name: t, short: e.short ?? t, disabled: e.disabled ?? !1 };
    return (e.description && (n.description = e.description), n);
  });
}
var An = Dn((e, t) => {
  let { pageSize: n = 7, validate: r = () => !0 } = e,
    i = Ct(On, e.theme),
    [a, o] = H(`loading`),
    [s, c] = H(``),
    [l, u] = H([]),
    [d, f] = H(),
    p = K(!1),
    m = wt({ status: a, theme: i }),
    h = G(() => ({ first: l.findIndex(Z), last: l.findLastIndex(Z) }), [l]),
    [g = h.first, _] = H();
  U(() => {
    ...
    return (
      ...
      (async () => {
        try {
          let n = await e.source(s || void 0, { signal: t.signal });
          if (!t.signal.aborted) {
            let t = kn(n),
              r;
            if (!p.current && `default` in e) {
              let n = t.findIndex((t) => Z(t) && t.value === e.default);
              ((r = n === -1 ? void 0 : n), (p.current = !0));
            }
            (_(r), f(void 0), u(t), o(`idle`));
          }
        } catch (e) {
          !t.signal.aborted && e instanceof Error && f(e.message);
        }
      })(),
      () => {
        t.abort();
  ...
  Tt(async (e, n) => {
    if (et(e))
      if (v) {
        o(`loading`);
        let e = await r(v.value);
        (o(`idle`),
          e === !0
            ? (o(`done`), t(v.value))
            : v.name === s
              ? f(e || `You must provide a valid value`)
              : (n.write(v.name), c(v.name)));
      } else n.write(s);
    else if (Qe(e) && v) (n.clearLine(0), n.write(v.name), c(v.name));
    else if (a !== `loading` && (R(e) || z(e))) {
      if ((n.clearLine(0), (R(e) && g !== h.first) || (z(e) && g !== h.last))) {
        let t = R(e) ? -1 : 1,
          n = g;
        do n = (n + t + l.length) % l.length;
        while (!Z(l[n]));
        _(n);
      }
    } else c(n.line);
  });
  let y = i.style.message(e.message, a),
    b = i.style.keysHelpTip([
      [`↑↓`, `navigate`],
      [`⏎`, `select`],
    ]),
    x = en({
      items: l,
      active: g,
      renderItem({ item: e, isActive: t }) {
        if (X.isSeparator(e)) return ` ${e.separator}`;
        if (e.disabled) {
          let t = typeof e.disabled == `string` ? e.disabled : `(disabled)`;
          return i.style.disabled(`${e.name} ${t}`);
        }
        return (t ? i.style.highlight : (e) => e)(`${t ? i.icon.cursor : ` `} ${e.name}`);
      },
      pageSize: n,
      loop: !1,
    }),
  ...
  d
    ? (S = i.style.error(d))
    : l.length === 0 && s !== `` && a === `idle` && (S = i.style.error(`No results found`));
  let C;
  if (a === `done` && v) return [m, y, i.style.answer(v.short)].filter(Boolean).join(` `).trimEnd();
  C = i.style.searchTerm(s);
  let w = v?.description;
  return [
    [m, y, C].filter(Boolean).join(` `).trimEnd(),
    [S ?? x, ` `, w ? i.style.description(w) : ``, b]
      .filter(Boolean)
      .join(`
`)
      .trimEnd(),
...
var Fn = Dn((e, t) => {
  let { loop: n = !0, pageSize: r = 7 } = e,
    i = Ct(jn, e.theme),
    { keybindings: a } = i,
    [o, s] = H(`idle`),
    c = wt({ status: o, theme: i }),
    l = K(),
    u = !a.includes(`vim`),
    d = G(() => Pn(e.choices), [e.choices]),
    f = G(() => {
      let e = d.findIndex(Nn),
        t = d.findLastIndex(Nn);
      if (e === -1)
        throw new at(`[select prompt] No selectable choices. All choices are disabled.`);
      return { first: e, last: t };
    }, [d]),
    p = G(
      () => (`default` in e ? d.findIndex((t) => Mn(t) && t.value === e.default) : -1),
      [e.default, d],
    ),
    [m, h] = H(p === -1 ? f.first : p),
    g = d[m];
  if (g == null || X.isSeparator(g)) throw Error(`Active index does not point to a choice`);
  let [_, v] = H();
  (Tt((e, r) => {
    if ((clearTimeout(l.current), _ && v(void 0), et(e)))
      g.disabled ? v(i.i18n.disabledError) : (s(`done`), t(g.value));
    else if (R(e, a) || z(e, a)) {
      if ((r.clearLine(0), n || (R(e, a) && m !== f.first) || (z(e, a) && m !== f.last))) {
        let t = R(e, a) ? -1 : 1,
          n = m;
        do n = (n + t + d.length) % d.length;
        while (!Nn(d[n]));
        h(n);
      }
    } else if ($e(e) && !Number.isNaN(Number(r.line))) {
      let e = Number(r.line) - 1,
        t = -1,
        n = d.findIndex((n) => (X.isSeparator(n) ? !1 : (t++, t === e))),
        i = d[n];
      (i != null && Mn(i) && h(n),
        (l.current = setTimeout(() => {
          r.clearLine(0);
        }, 700)));
    } else if (Ze(e)) r.clearLine(0);
    else if (u) {
      let e = r.line.toLowerCase(),
        t = d.findIndex((t) =>
          X.isSeparator(t) || !Mn(t) ? !1 : t.name.toLowerCase().startsWith(e),
        );
      (t !== -1 && h(t),
        (l.current = setTimeout(() => {
          r.clearLine(0);
  ...
  let y = i.style.message(e.message, o),
    b = i.style.keysHelpTip([
      [`↑↓`, `navigate`],
      [`⏎`, `select`],
    ]),
    ...
    S = en({
      items: d,
      active: m,
      renderItem({ item: e, isActive: t, index: n }) {
        if (X.isSeparator(e)) return (x++, ` ${e.separator}`);
        let r = t ? i.icon.cursor : ` `,
          a = i.indexMode === `number` ? `${n + 1 - x}. ` : ``;
        if (e.disabled) {
          let n = typeof e.disabled == `string` ? e.disabled : `(disabled)`,
            r = t ? i.icon.cursor : `-`;
          return i.style.disabled(`${r} ${a}${e.name} ${n}`);
        }
        return (t ? i.style.highlight : (e) => e)(`${r} ${a}${e.name}`);
      },
      pageSize: r,
      loop: n,
    });
  if (o === `done`) return [c, y, i.style.answer(g.short)].filter(Boolean).join(` `);
  let { description: C } = g;
  return `${[
    [c, y].filter(Boolean).join(` `),
    S,
    ` `,
    C ? i.style.description(C) : ``,
    _ ? i.style.error(_) : ``,
    b,
  ]
    .filter(Boolean)
...
function In(e) {
  ...
  throw Error(`add requires a fetch implementation`);
}
async function Ln(e) {
  if (e.ok) return await e.json();
  if (O(e.headers.get(`content-type`), ``).includes(`application/json`)) {
    let t = await e.json();
    if (e.status === 401 && L(t.error, `invalid_token`))
      throw Error(
    ...
    if (n !== void 0) r = n;
      ...
      let n = t.message;
      r = n === void 0 ? `HTTP ` + e.status.toString() : n;
    }
    throw Error(r);
  }
  let t = await e.text(),
    n = t === `` ? `HTTP ` + e.status.toString() : t;
  throw Error(n);
}
async function Rn(e) {
  let t = n.join(e, `package.json`);
  try {
    return JSON.parse(await s.readFile(t, `utf8`));
  } catch (e) {
    let n = j(P(e));
    if (n !== void 0) {
      if (L(D(n).code, `ENOENT`)) return {};
      throw Error(`Could not parse ` + t);
    }
    throw Error(`Could not parse ` + t);
  }
}
async function zn(e, t, n) {
  let r = h.createInterface({ input: e, output: t }),
    i = await r.question(n);
  return (r.close(), i);
}
async function Bn(e, t, n) {
  let r = (await zn(e, t, n)).trim();
  if (r === ``) throw Error(`Package name is required`);
  return r;
}
async function Vn(e, t, n, r) {
  let i = (await zn(e, t, n + ` [` + r + `]: `)).trim();
  return i === `` ? r : i;
}
function Hn(e) {
  try {
    ...
    let t = P(e);
    throw t.RE_EXN_ID === F ? Error(I) : t;
  }
}
async function Un(e, t, n) {
  if (!O(t.isTTY, !1) || !O(n.isTTY, !1))
    throw Error(`add requires a package argument when not running in an interactive terminal`);
  return e.length === 0
    ? await Bn(t, n, `Package name: `)
    : await An(
        {
          ...
          source: async (t, n) => {
            let r = O(t, ``).trim(),
              i = e
                .filter((e) => (r === `` ? !0 : e.includes(r)))
                .map((e) => ({ name: e, value: e }));
            return r !== `` && !e.some((e) => e === r)
              ? i.concat([{ name: `Use custom package "` + r + `"`, value: r }])
              : i;
          },
        },
        { input: t, output: n },
...
function Wn(e) {
  return Oe({
    author: e.publisherLogin,
    packageRange: e.peerPackageRange,
    rescriptRange: e.rescriptRange,
    isPackageCompatible: e.isPackageCompatible,
    isRescriptCompatible: e.isRescriptCompatible,
  });
}
function Gn(e, t, n) {
  return Ce(e, n.length, (e, n) => Se(e, t(n).length));
}
function Kn(e, t, n) {
  return n.author.padEnd(e) + `  ` + n.packageText.padEnd(t) + `  ` + n.rescriptText;
}
async function qn(e, t) {
  let n = O({}.stdout, a.stdout),
    r = O({}.stdin, a.stdin);
  if (!O(r.isTTY, !1) || !O(n.isTTY, !1))
    throw Error(`add requires an interactive terminal when multiple releases are available`);
  let i = e.map(Wn),
    o = Gn(i, (e) => e.author, `Author`),
    s = Gn(i, (e) => e.packageText, `Package`),
    c = `  ` + `Author`.padEnd(o) + `  ` + `Package`.padEnd(s) + `  ReScript`,
    l = t.log;
  return (
    l(`Available binding releases:`),
    l(c),
    await Fn(
      {
        ...
        pageSize: 8,
        loop: !0,
        choices: e.map((e, t) => ({ name: Kn(o, s, k(i[t])), value: e })),
      },
      { input: r, output: n },
    )
  );
...
async function Jn(e, t) {
  let n = O({}.stdout, a.stdout),
    r = O({}.stdin, a.stdin);
  if (!O(r.isTTY, !1) || !O(n.isTTY, !1))
    throw Error(`add requires an interactive terminal before overwriting files`);
  let i = t.log;
  (i(`The following files already exist:`), e.forEach((e) => i(`  ` + e)));
  let o = (await zn(r, n, `Overwrite these files? [y/N]: `)).trim().toLowerCase();
  return o === `y` ? !0 : o === `yes`;
}
async function Yn(e, t, n, r) {
  let i = Te + `/v1/packages/` + encodeURIComponent(e) + `/releases`,
    a = [];
  return (
    t !== void 0 && a.push(`packageVersion=` + encodeURIComponent(t)),
    n !== void 0 && a.push(`rescriptVersion=` + encodeURIComponent(n)),
    O((await Ln(await r(a.length === 0 ? i : i + `?` + a.join(`&`)))).releases, [])
  );
}
async function Xn(e, t) {
  return await Ln(await t(Te + `/v1/releases/` + encodeURIComponent(e)));
}
async function Zn(e, t, n) {
  if (!O(e.isTTY, !1) || !O(t.isTTY, !1)) return n;
  let r = n,
    i = !1;
  for (; !i; ) {
    let n = await Vn(e, t, `Install file`, r);
    try {
      ((r = Ge(n)), (i = !0));
    } catch (e) {
      let n = P(e);
...
function Qn(e, t) {
  let r = n.resolve(e),
    i = Hn(t),
    a = n.resolve(r, i),
    o = (r.startsWith(n.sep) && r === n.sep) || r.endsWith(n.sep) ? r : r + n.sep;
  if (a !== r && !a.startsWith(o)) throw Error(`Release file escapes install folder: ` + i);
  return a;
}
async function $n(e, t, r, i, a) {
  if (t !== void 0 && t.trim() !== ``) {
    let r = n.resolve(e, t),
      i = n.relative(e, r);
    return { summaryPath: i === `` ? `.` : i, targetPathForFile: (e) => Qn(r, e.relativePath) };
  }
  if (r.files.length === 1) {
    let t = k(r.files[0]),
      o = await Zn(i, a, Je(r.packageName, n.extname(t.relativePath))),
      s = n.resolve(e, o),
      c = n.relative(e, s);
    return { summaryPath: c === `` ? `.` : c, targetPathForFile: (e) => s };
  }
  let o = n.resolve(e, qe(r.packageName)),
    s = n.relative(e, o);
  return { summaryPath: s === `` ? `.` : s, targetPathForFile: (e) => Qn(o, e.relativePath) };
}
async function er(e) {
  let t = [];
  for (let n = 0, r = e.length; n < r; ++n) {
    ...
    if (r !== void 0)
      try {
        (await s.readFile(r.targetPath, `utf8`), t.push(r.targetPath));
      } catch (e) {
        let t = P(e),
          n = j(t);
        if (n !== void 0) {
          if (!L(D(n).code, `ENOENT`)) throw t;
        } else throw t;
      }
  }
  return t;
...
async function tr(e) {
  for (let t = 0, r = e.length; t < r; ++t) {
    let r = e[t];
    r !== void 0 &&
      (await s.mkdir(n.dirname(r.targetPath), { recursive: !0 }),
      await s.writeFile(r.targetPath, r.content, `utf8`));
  }
}
async function nr(e, t, n) {
  let r = In(ye(n.fetch, globalThis.fetch)),
    i = O(n.cwd, a.cwd()),
    o = O(n.log, (e) => {
      console.log(e);
    }),
    s = O(n.stdin, a.stdin),
    c = O(n.stdout, a.stdout),
    l = O(n.selectRelease, qn),
    u = O(n.confirmOverwrite, Jn),
    d = await Rn(i),
    f = e === void 0 || e.trim() === `` ? await Un(xe(d), s, c) : e.trim(),
    p = await Yn(f, A(d, f), A(d, `rescript`), r);
  if (p.length === 0) return o(`No bindings found for ` + f + `.`);
  let m = { stdin: s, stdout: c, log: o },
    h = await Xn((await l(p, m)).id, r),
    g = await $n(i, t, h, s, c),
    _ = h.files.map((e) => ({ targetPath: g.targetPathForFile(e), content: e.content })),
    v = await er(_);
  return v.length === 0 || (await u(v, m))
    ? (await tr(_), o(`Installed ` + h.packageName + ` to ` + g.summaryPath))
    : o(`Install cancelled.`);
}
...
function or(e) {
  let t = e.replaceAll(`\\`, `/`),
    n = t.lastIndexOf(`/`);
  return n < 0 ? t : t.slice((n + 1) | 0);
}
function sr(e) {
  return e.endsWith(`.resi`)
    ? e.slice(0, (e.length - 5) | 0)
    : e.endsWith(`.res`)
      ? e.slice(0, (e.length - 4) | 0)
      : e;
}
function cr(e) {
  return sr(or(e));
...
function lr(e) {
  return e.endsWith(`.res`) ? !0 : e.endsWith(`.resi`);
}
function ur(e) {
  return e.startsWith(`.`) || e === `node_modules` || e === `lib` || e === `dist` || e === `build`
    ? !0
    : e === `coverage`;
}
function dr(e, t, n) {
  return t !== void 0 && e ? t - n > 6e4 : !1;
}
function fr(e, t) {
  return e ? `Reuse` : t ? `Refresh` : `Interactive`;
}
function pr(e) {
  switch (e) {
    case `Reuse`:
...
function Q(e) {
  let t = j(e);
  if (t !== void 0) return xr(D(t));
  throw e;
}
function Sr(e) {
  return e === void 0 ? gr() : O(D(e).deps, gr());
}
function Cr(e) {
  let t = e.hostname,
    n;
  if (t !== void 0)
    if (t !== ``) n = t;
    else throw Error(`cacheFilePathFor requires a hostname`);
  else throw Error(`cacheFilePathFor requires a hostname`);
  let r = O(e.platform, a.platform),
    i = O(e.homeDir, p.homedir()).replaceAll(`\\`, `/`),
    o = n + `.json`;
  return r === `darwin`
    ? [i, `Library`, `Application Support`, `rescript-bindings`, `oauth`, o].join(`/`)
    : r === `win32`
      ? [i, `rescript-bindings`, `oauth`, o].join(`/`)
      : [i, `.local`, `state`, `rescript-bindings`, `oauth`, o].join(`/`);
}
function wr(e, t) {
  if (e === void 0) return !1;
  let n = D(e);
  return dr(n.accessToken !== void 0, n.expiresAt, t);
}
function Tr(e, t) {
  return mr(wr(e, t), e === void 0 ? !1 : D(e).refreshToken !== void 0);
}
function Er(e) {
  return m.createHash(`sha256`).update(e).digest(`base64url`);
}
function Dr() {
  return m.randomBytes(24).toString(`hex`);
}
function Or() {
  return m.randomBytes(48).toString(`base64url`);
}
async function kr(e) {
  try {
    return JSON.parse(await s.readFile(e, `utf8`));
  } catch {
    return null;
  }
}
async function Ar(e, t) {
  return (
    await s.mkdir(n.dirname(e), { recursive: !0 }), await s.writeFile(e, JSON.stringify(t), `utf8`)
  );
}
function jr(e, t) {
  return e === `darwin`
...
function Mr(e, t, n) {
  return new Promise((r) => {
    let i = e(t, n, { stdio: `ignore` });
    (i.once(`error`, () => r(!1)), i.once(`close`, (e) => r(e === 0)));
  });
}
async function Nr(e, n) {
  let r = n === void 0 ? a.platform : O(D(n).platform, a.platform),
    i = n === void 0 ? t.spawn : O(D(n).spawn, t.spawn),
    o =
      n === void 0
        ? (e) => {
            console.log(e);
    ...
    s = jr(r, e);
  if (!(await Mr(i, s[0], s[1])))
    return (o(`Could not open a browser automatically. Open this URL to continue:`), o(e));
}
function Pr(e) {
  let t = e.callbackUrl.searchParams,
    n = t.get(`code`),
    r = t.get(`state`),
    i = t.get(`error`),
    a = t.get(`error_description`);
  if (i != null)
    throw Error(a == null ? `OAuth callback error: ` + i : `OAuth callback error: ` + i + `: ` + a);
  if (n != null && r != null) {
    if (r !== e.expectedState) throw Error(`OAuth state validation failed`);
    return { code: n, state: r };
  }
  let o = t.toString();
  throw Error(
    o === ``
      ? `OAuth callback missing code or state. Callback query was empty.`
      : `OAuth callback missing code or state. Callback query: ` + o,
  );
}
async function Fr(e) {
  return await (async () => {
    let { createServer: e } = await import(`node:http`),
      t,
      n,
      r = new Promise((e, r) => {
        ((t = e), (n = r));
      ...
      i = e((e, r) => {
        let i = new URL(e.url, `http://127.0.0.1`);
        if (i.pathname !== `/callback`) {
          ((r.statusCode = 404), r.end(`Not found`));
          return;
        }
        try {
          let e = Pr({ callbackUrl: i, expectedState });
          ((r.statusCode = 200),
            r.end(`Authentication complete. You can return to the terminal.`),
            t(e));
        } catch (e) {
          ((r.statusCode = 400), r.end(e.message), n(e));
        }
      });
    await new Promise((e, t) => {
      (i.once(`error`, t), i.listen(0, `127.0.0.1`, e));
    });
    let a = i.address();
    if (!a || typeof a == `string`) throw Error(`Failed to allocate loopback callback port`);
    return {
      redirectUri: `http://127.0.0.1:` + a.port + `/callback`,
      waitForCode: async () => r,
      close: async () =>
        new Promise((e, t) => {
          i.close((n) => (n ? t(n) : e()));
...
function Ir(e, t, n) {
  return xr(Object.assign(Error(e), { status: t, payload: n }));
}
async function $(e) {
  if (e.ok) return await e.json();
  if (O(e.headers.get(`content-type`), ``).includes(`application/json`)) {
    ...
    return Ir(r, e.status, ge(t));
  }
  let t = await e.text();
  return Ir(t === `` ? `HTTP ` + e.status.toString() : t, e.status, void 0);
}
function Lr(e) {
  return e.refreshToken === void 0 ? !1 : e.clientId !== void 0;
}
function Rr(e) {
  let t = j(e);
  if (t === void 0) return !1;
  let n = D(t).status;
  return n === void 0 ? !1 : n === 401 ? !0 : n === 403;
}
function zr(e) {
  if (Rr(e)) return !0;
  let t = j(e);
...
function Br(e) {
  return e?.match(/resource_metadata="([^"]+)"/)?.[1];
}
function Vr(e) {
  let t = new URL(e);
  return (
    (t.pathname = `/.well-known/oauth-authorization-server`),
    (t.search = ``),
    (t.hash = ``),
    t.toString()
  );
...
async function Hr(e) {
  let t = ve(
    (await e(M + `/v1/me`, { method: `GET`, redirect: `manual` })).headers.get(`www-authenticate`),
    Br,
  );
  if (t !== void 0) {
    let n = (await $(await e(t, {}))).authorization_servers,
      r;
    if (n !== void 0) {
      let e = n[0];
      if (e !== void 0) r = e;
      else throw Error(`Cloudflare Access resource metadata did not include authorization_servers`);
    } else throw Error(`Cloudflare Access resource metadata did not include authorization_servers`);
    return await $(await e(Vr(r), {}));
  }
  return await $(
    await e(new URL(`/.well-known/oauth-authorization-server`, M).toString(), {
      method: `GET`,
      redirect: `manual`,
    }),
  );
...
function Ur(e) {
  return e.map((e) => encodeURIComponent(e[0]) + `=` + encodeURIComponent(e[1])).join(`&`);
}
async function Wr(e, t, n) {
  ...
  return await $(await n(e.registration_endpoint, { method: `POST`, headers: _r(), body: r }));
}
async function Gr(e, t, n, r, i, a) {
  ...
  return await $(await a(e.token_endpoint, { method: `POST`, headers: vr(), body: o }));
}
async function Kr(e, t, n, r) {
  ...
  return await $(await r(e.token_endpoint, { method: `POST`, headers: vr(), body: i }));
}
function qr(e, t, n, r, i) {
  let a = e.refresh_token;
  return (
    a !== void 0 || (i !== void 0 && D(i).refreshToken),
    {
      accessToken: e.access_token,
      refreshToken: a,
      expiresAt: r + e.expires_in * 1e3,
      tokenEndpoint: t.token_endpoint,
      authorizationEndpoint: t.authorization_endpoint,
      registrationEndpoint: t.registration_endpoint,
      clientId: n,
      resource: li,
      publishBaseUrl: ci,
    }
...
function Jr(e) {
  return {
    githubLogin: e.githubLogin ?? void 0,
    displayName: e.displayName ?? void 0,
    email: e.email ?? void 0,
  };
}
async function Yr(e, t) {
  return Jr(await $(await t(M + `/v1/me`, { method: `GET`, headers: yr(e) })));
}
async function Xr(e, t) {
  return { identity: await Yr(e, t), accessToken: e };
}
async function Zr(e) {
  let t = Sr(e),
    n = ye(t.fetch, globalThis.fetch),
    r;
  if (n !== void 0) r = n;
  else throw Error(`OAuth helper requires a fetch implementation`);
  let i = O(t.now, (e) => Date.now()),
    o = O(t.platform, a.platform),
    s = O(t.homeDir, o === `win32` ? O(ir(`APPDATA`), p.homedir()) : p.homedir()),
    c = O(t.readCache, kr),
    l = O(t.writeCache, Ar),
    u = O(t.openBrowser, (e) => Nr(e, void 0)),
    d = O(t.createLoopbackServer, Fr),
    f = O(t.randomString, Dr),
    m = O(t.codeVerifier, Or),
    h = O(t.codeChallengeFromVerifier, Er),
    g = new URL(M).hostname,
    _ = Cr({ platform: o, homeDir: s, hostname: g }),
    v = hr(await c(_)),
    y = Tr(v, i()),
    b = { contents: void 0 },
    x = async () => {
    ...
    S = async (e) => {
      let t = await x(),
        ...
        a;
      if (n !== void 0) a = n;
      else throw Error(`Cached OAuth bundle is missing clientId`);
      let o = e.refreshToken,
        s;
      if (o !== void 0) s = o;
      else throw Error(`Cached OAuth bundle is missing refreshToken`);
      let c = qr(await Kr(t, a, s, r), t, a, i(), ge(e));
      return (await l(_, c), await Xr(k(c.accessToken), r));
    },
    C = async () => {
      let e = await x(),
        t = f(),
        n = m(),
        a = h(n),
        o = await d({ expectedState: t });
      try {
        let s = await Wr(e, o.redirectUri, r),
          c = new URL(e.authorization_endpoint),
          d = c.searchParams;
        (d.set(`client_id`, s.client_id),
          d.set(`redirect_uri`, o.redirectUri),
          d.set(`response_type`, `code`),
          d.set(`resource`, N),
          d.set(`code_challenge`, a),
          d.set(`code_challenge_method`, `S256`),
          d.set(`state`, t),
          await u(c.toString()));
        let f = await o.waitForCode(),
          p = qr(
            await Gr(e, s.client_id, o.redirectUri, f.code, n, r),
            e,
            s.client_id,
            i(),
            void 0,
          );
        return (await l(_, p), await Xr(k(p.accessToken), r));
      } catch (e) {
        let t = P(e);
        return (await o.close(), Q(t));
      }
    };
  switch (y) {
    case `refresh`:
      if (v === void 0) return await C();
      let e = D(v);
      if (!Lr(e)) return await C();
      try {
        return await S(e);
      } catch (e) {
        let t = P(e);
        return (zr(t) || Q(t), await C());
      }
    case `reuse`:
      let t = k(v),
        n = k(t.accessToken);
      try {
        ...
        let n = P(e);
        if ((Rr(n) || Q(n), !Lr(t))) return await C();
        try {
          return await S(t);
        } catch (e) {
          let t = P(e);
...
async function ei(e, t, n, r, i) {
  let a =
      i === void 0
        ? h.createInterface({ input: e, output: t })
        : h.createInterface({ input: e, output: t, completer: i }),
    o = await $r(a, n, r);
  return (a.close(), o);
}
async function ti(e, t, n) {
  return e.length === 0
    ? await ei(t, n, `Package name`, void 0, void 0)
    : await An(
        {
          message: `Package name`,
          pageSize: 8,
...
async function ni(e, t) {
  let n = h.createInterface({ input: e, output: t }),
    r = (await n.question(`Publish this release? [y/N]: `)).trim().toLowerCase();
  return (n.close(), r === `y` ? !0 : r === `yes`);
}
function ri(e) {
  return (t) => {
    let r = t.trim(),
      a = r.endsWith(n.sep) ? r : n.dirname(r),
      o = r.endsWith(n.sep) ? `` : n.basename(r),
      s = a === `.` ? `` : a,
      c = n.resolve(e, s === `` ? `.` : s);
    try {
      let r = i
        ...
        .filter((e) => e.name.startsWith(o))
        .map((t) => {
          let r = s === `` ? t.name : n.join(s, t.name);
          try {
            return i.statSync(n.resolve(e, r)).isDirectory() ? r + n.sep : r;
          } catch {
            return r;
          }
        });
...
async function ii(e, t) {
  let r = n.resolve(t, e),
    i = await s.stat(r);
  if (i.isFile()) {
    if (!lr(r)) throw Error(`Binding file must end with .res or .resi`);
    return [{ relativePath: n.basename(r), content: await s.readFile(r, `utf8`) }];
  }
  if (!i.isDirectory()) throw Error(`Binding source must be a file or folder`);
  let a = [],
    o = async (e, t) => {
      let r = await s.readdir(e, { withFileTypes: !0 });
      for (let i = 0, c = r.length; i < c; ++i) {
        let c = r[i];
        if (c !== void 0) {
          let r = D(c);
          if (r.isDirectory()) ur(r.name) || (await o(n.join(e, r.name), n.join(t, r.name)));
          else if (r.isFile()) {
            let i = r.name;
            if (!i.startsWith(`.`) && lr(i)) {
              let r = ar(n.join(t, i));
              a.push({ relativePath: r, content: await s.readFile(n.join(e, i), `utf8`) });
            }
          }
        }
      }
  ...
  if (
    (await o(r, ``), a.sort((e, t) => e.relativePath.localeCompare(t.relativePath)), a.length === 0)
  )
    throw Error(`Binding folder did not contain any .res or .resi files`);
  return a;
}
async function ai(e) {
  let t = e.cwd,
    n = e.stdin,
    r = e.stdout;
  if (Xe(n.isTTY, !0) || Xe(r.isTTY, !0))
    throw Error(`binding publish requires an interactive terminal`);
  let i = await Qr(t),
    a = A(i, `rescript`),
    o = await ti(xe(i), n, r),
    s = A(i, o),
    c = await ei(n, r, `Binding file or folder`, void 0, ri(t)),
    l = await ei(n, r, `Package version`, s, void 0),
    u = await ei(n, r, `ReScript version`, a, void 0),
    d = await ii(c, t),
    f = cr(c);
  return (
    console.log(``),
    console.log(`Publish summary:`),
    console.log(`  Package: ` + o),
    console.log(`  Binding source: ` + c),
    console.log(`  Variant: ` + f),
    console.log(`  Files: ` + d.length.toString()),
    console.log(`  Package version: ` + l),
    console.log(`  ReScript version: ` + u),
    console.log(``),
    (await ni(n, r))
      ? {
          packageName: o,
...
async function oi(e, t, n) {
  return await $(
    await n(M + `/v1/releases`, { method: `POST`, headers: br(t), body: JSON.stringify(e) }),
  );
}
async function si(e) {
  let t = Sr(e),
    ...
    r;
  if (n !== void 0) r = n;
  else throw Error(`Publish helper requires a fetch implementation`);
  let i = O(t.cwd, a.cwd()),
    o = hr(
      await O(
        t.promptForPublishInput,
        ai,
      )({ cwd: i, stdin: O(t.stdin, a.stdin), stdout: O(t.stdout, a.stdout) }),
    );
  if (o !== void 0) {
    let t = await Zr(e),
      n = await oi(D(o), t.accessToken, r);
    (n.duplicate
      ? console.log(`Release already exists: ` + n.releaseId)
      : console.log(`Published release: ` + n.releaseId),
      console.log(
        n.packageName +
          ` (` +
...
function pi(e) {
  e.command(`add`)
    ...
    .action(async (e, t) => await rr(O(e, ``), t.folder));
}
function mi(e) {
  e.command(`publish`)
    .description(`Publish local .res/.resi bindings`)
    .action(async () => await si(void 0));
}
function hi() {
  let e = fi(new fe());
  return (pi(e), mi(e), e);
...
function vi(e) {
  ...
  switch (r) {
    ...
    case `commander.version`:
      return !0;
    default:
      if (!r.startsWith(`commander.`)) return !1;
      let e = O(n.exitCode, 1);
      return ((process.exitCode = e), !0);
  }
}
async function yi(e, t) {
  let n = e === void 0 ? process.argv : e,
    r = hi();
  try {
    return await r.parseAsync(n);
  } catch (e) {
    let t = P(e);
    if (vi(t)) return;
    throw t;
...
let bi = ui(yi(void 0, void 0), async (e) => {
  let t = j(e),
    n = t === void 0 ? `Command failed` : O(we(D(t)), `Command failed`);
  (console.error(n), (process.exitCode = 1));
});
export {
  pi as addAddCommand,
  mi as addPublishCommand,
  fi as configureBaseProgram,
  vi as handleCommanderError,
  _i as isCommanderCode,
  hi as makeProgram,
  bi as ready,
  di as red,
  yi as run,
  gi as setProcessExitCode,
};
